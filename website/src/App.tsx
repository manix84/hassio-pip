...
import controlMockup from "./assets/home-assistant-control.jpg";
import cameraNotificationScreenshot from "./assets/ha-tv-pip-camera-notification.jpg";
import cameraPopupScreenshot from "./assets/ha-tv-pip-camera-popup.jpg";
import dashboardScreenshot from "./assets/ha-tv-pip-dashboard.png";
import homepageNotificationScreenshot from "./assets/ha-tv-pip-homepage-camera-notification.jpg";
import homepagePopupScreenshot from "./assets/ha-tv-pip-homepage-camera-popup.jpg";
import networkMockup from "./assets/local-network-pip.jpg";
import heroCleanMockup from "./assets/tv-pip-hero-clean.jpg";
import phaseOnePromoMockup from "./assets/tv-pip-promo.jpg";
