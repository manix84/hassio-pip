...
export const pl = {
    ...
    currentStatus: { body: ["HA TV PiP obsługuje już wykrywanie, parowanie widoczne na telewizorze, uwierzytelnione sterowanie odbiornikiem, popupy kamer, snapshoty, stylizowane powiadomienia, zarządzanie odbiornikiem i zdalny transport odbiornika.", "Trwa praca nad kompatybilnością po v1.0. Skupiamy się na kalibracji kamer, zapisanych rekomendacjach, źródłach bezpiecznych dla TV, diagnostyce odbiornika i przyszłych rozszerzeniach restreamingu."], eyebrow: "Aktualny stan", title: "Dopracowanie kompatybilności po v1.0" },
    ...
    deviceSupport: { eyebrow: "Obsługa urządzeń", title: "Obsługa platform będzie rozszerzana ostrożnie.", items: [{ title: "Android TV i Google TV", label: "Obsługiwane", status: "complete", description: "Aktualny cel aplikacji odbiornika i aktywna platforma rozwoju." }, { title: "Fire TV i Vega OS", label: "Następne", status: "planned", description: "Platformy najbliższe modelowi odbiornika Android." }, { title: "Samsung Tizen, LG webOS, Roku i Apple TV", label: "Badania", status: "future", description: "Ważne platformy, które mogą wymagać osobnych projektów odbiornika." }, { title: "VIDAA, TiVo OS i platformy operatorów", label: "Obserwacja", status: "future", description: "Do śledzenia, aż pojawi się jasna ścieżka dystrybucji." }] },
    faqItems: [
