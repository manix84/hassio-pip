...
export const nl = {
    ...
    currentStatus: { body: ["HA TV PiP ondersteunt nu discovery, koppelen met code op de tv, geauthenticeerde receiverbediening, camera-pop-ups, snapshots, gestylede notificaties, receiverbeheer en remote receiver transport.", "Post-v1.0 compatibiliteitswerk is bezig. De focus ligt op camerakalibratie, opgeslagen aanbevelingen, TV-veilige streamtips, receiverdiagnostiek en geplande restreaming-uitbreidingen."], eyebrow: "Huidige status", title: "Post-v1.0 compatibiliteitspolish" },
    example: { eyebrow: "Voorbeeldautomatisering", mjpegTitle: "MJPEG-fallback", standardTitle: "Standaard HLS-pad", tabAriaLabel: "Type voorbeeldautomatisering", title: "Waar dit naartoe gaat." },
    deviceSupport: { eyebrow: "Apparaatondersteuning", title: "Platformondersteuning groeit voorzichtig.", items: [{ title: "Android TV en Google TV", label: "Ondersteund", status: "complete", description: "Het huidige receiverdoel en de actieve ontwikkelplatformen." }, { title: "Fire TV en Vega OS", label: "Volgende kans", status: "planned", description: "Het dichtst bij het Android-receivermodel en daarom de meest logische volgende stap." }, { title: "Samsung Tizen, LG webOS, Roku en Apple TV", label: "Onderzoek", status: "future", description: "Waardevolle platformen die waarschijnlijk aparte receiverontwerpen nodig hebben." }, { title: "VIDAA, TiVo OS en operatorplatformen", label: "Watchlist", status: "future", description: "Volgen tot er een duidelijke distributieroute en nuttig receivermodel is." }] },
    faqItems: [
      ...
      { question: "Wat moet ik meesturen in een beta-bugrapport?", answer: "Vermeld de Android receiver-versie, Home Assistant-integratieversie, Home Assistant-versie, tv-model, cameraplatform, streamstrategie, service-YAML en geredigeerde diagnostiek. De troubleshooting-gids bevat de controles die je eerst kunt uitvoeren." },
